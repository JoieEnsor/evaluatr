# =============================================================================
# evaluatr Example 3: Weibull AFT model — breast cancer relapse
# =============================================================================
#
# Demonstrates the evaluatr workflow for a survival outcome model (Weibull AFT).
#
# Model: Weibull accelerated failure time model for relapse-free survival
...
bc_weibull_result <- secure_model_validation(
...
head(bc_weibull_result$full_shuffled_matrix)

# Column names reflect the timepoints:
colnames(bc_weibull_result$full_shuffled_matrix)
